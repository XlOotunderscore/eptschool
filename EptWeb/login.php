...
<head>
  ...
  <title>SwiftPHP - Connexion - Formateur</title>
      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h2 class="mb-2">Etudiant</h2>
            <p class="mb-4">Veuillez vous connecter avant de poursuivre</p>

            <form id="formAuthentication" class="mb-3" action="" method="POST">
              <div class="mb-3">
                <label for="mat" class="form-label">Matricule</label>
                <input type="text" class="form-control" value="<?php if(isset($errors)) echo $mat; ?>" id="mat" name="mat" placeholder="Entrez votre matricule" autofocus />
              </div>
              <div class="mb-3 form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="password" id="password" value="<?php if(isset($errors)) echo $password; ?>" class="form-control" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
