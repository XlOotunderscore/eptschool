...
<?php
        ...
        $classe = Classe::getById($_SESSION['auth']->codeClasse);
        $matieres = array();
        $coefs = array();
        $moyennes = array();
        $moyennesPond = array();
        ...
        $suivres = Suivre::getByMatriculeDistinct($_SESSION['auth']->matricule, true);
        ...
        foreach ($matieres as $matiere) {
            ...
            $suivres = Suivre::getBySubId($_SESSION['auth']->matricule, $matiere, true);
            $moy = 0;
            foreach ($suivres as $suivre) {
                $moy += $suivre->note;
            }
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            <div class="d-flex justify-content-end">
                                <div id="download" onclick="print()" class="btn btn-primary mb-4">Télécharger<i
                                            ...
                                            <div class="row w-100">
                                                <div class="col">
                                                    <p class="fw-bold">Matricule : <span
                                                            class="fw-lighter"><?= $_SESSION['auth']->matricule ?></span>
                                                    </p>
                                                    <p class="fw-bold">Nom : <span
                                                            class="fw-lighter"><?= $_SESSION['auth']->nom . ' ' . $_SESSION['auth']->prenom ?></span>
                                                    </p>
