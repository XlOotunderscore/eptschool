...
<head>
    ...
    <title>Mettre à jour une classe</title>
        ...
        if(isset($_POST["id"])){
            ...
            if(!isset($_POST["send"])){
                ...
                if(!isset($erreurs)){
                    ...
                    if(updateTableRecord('classe', array_merge(Classe::$fields, Classe::$fkeys), $valueList, Classe::$keys, $keyValues)){
            ...
            fillSessionFlash('warning', "Veuillez d'abord choisir une classe à modifier.");
            header("Location: classes.php");
            exit();
        }
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Classes /</span> Mise à jour de
                            classe</h4>
                        <div class="row">
                            <div class="col-xl">
                                <div class="card mb-4">
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="effectif" type="number"
                                                    value="<?php echo $effectif ?>" id="effectif">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="filiere" id="fil">
                                                    <?php foreach($filieres as $fil): ?>
                                                        <option <?php if($filiere == $fil->id) echo 'selected'; ?> value="<?= $fil->id ?>">(<?= $fil->id ?>) - <?= $fil->lib ?></option>
                                                    <?php endforeach; ?>
