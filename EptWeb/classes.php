...
<?php
        ...
        if(!empty($_POST['id'])){
            ...
            //Check de sécurité
            $item = Classe::getById($id);
            if($item)
            {
                //Trouvé, procéder à la suppression
                $reqDel = $pdo->prepare("DELETE FROM classe WHERE code_cl = ?");
                $reqDel->execute([$id]);
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Classes /</span> Liste des
                            classes</h4>
                        <div class="row">
                            <div class="d-flex justify-content-end">
                                <a href="add_classe.php">
                                    <div class="btn btn-primary mb-4">Nouvelle classe<i class="ms-2 fas fa-plus"></i>
                                    </div>
                                </a>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    if(count($results) > 0){
                                        foreach($results as $item)
                                        {
                                            ...
                                            $contenu .= '<td>('. $item->codeFil . ')'. Filiere::getById($item->codeFil)->lib . '</td>';
                        ...
                        <form action="edit_classe.php" style="display: none;" method="post" id="eForm">
