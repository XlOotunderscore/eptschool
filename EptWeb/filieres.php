...
<?php
        ...
        if(!empty($_POST['id'])){
            ...
            //Check de sécurité
            $item = Filiere::getById($id);
            if($item)
            {
                //Trouvé, procéder à la suppression
                $reqDel = $pdo->prepare("DELETE FROM filiere WHERE code_fil = ?");
                $reqDel->execute([$id]);
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Filières /</span> Liste des
                            filières</h4>
                        <div class="row">
                            <div class="d-flex justify-content-end">
                                <a href="add_filiere.php">
                                    <div class="btn btn-primary mb-4">Nouvelle filière<i class="ms-2 fas fa-plus"></i>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <form action="edit_filiere.php" style="display: none;" method="post" id="eForm">
